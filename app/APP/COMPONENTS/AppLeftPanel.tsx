    ...
    return (
        <div
            className={cn(
                ...
                "bg-gradient-to-b from-AppPrimary to-AppSecondary text-white"
            )}
        >
            <div className="flex flex-col items-center relative z-10">
                ...
                <h1 className="text-lg font-semibold tracking-wide text-center sm:text-left mt-3 drop-shadow-md">
                    BreedView
                </h1>
            </div>
